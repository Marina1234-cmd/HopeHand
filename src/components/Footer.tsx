...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Instagram', href: '#', icon: 'M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8zm0-15a7 7 0 100 14 7 7 0 000-14zm0 11.5a4.5 4.5 0 110-9 4.5 4.5 0 010 9zm0-7.5a3 3 0 100 6 3 3 0 000-6z' },
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">HopeHand</h3>
            <p className="text-gray-400">
              Empowering change through community support. Join us in making a difference, one campaign at a time.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/campaigns/create" className="text-gray-400 hover:text-white transition-colors">
                  Start a Campaign
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>123 Hope Street, Charity City, CH 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400">
              © {currentYear} HopeHand. All rights reserved.
            </p>
